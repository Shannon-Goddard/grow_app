// Cache DOM elements
const tableElement = document.getElementById('table4');
...
function saveTableState() {
    ...
    try {
        ...
        localStorage.setItem('page_html4', JSON.stringify(tempTable.innerHTML));
    } catch (error) {
...
$(function() {
    ...
    const initializeTable = () => {
        ...
        try {
            const savedContent = localStorage.getItem('page_html4');
            if (savedContent) {
