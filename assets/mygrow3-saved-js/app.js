...
$(function() {
  /////Retrieve Strain
  document.getElementById("strain").innerHTML = localStorage.plant3Strain;
  /////Retrieve Plant Height
  document.getElementById("Grow").innerHTML = localStorage.plant3Height;
  /////Retrieve Plant Logo
  ...
  var vegWeeks;
  vegWeeks = "";
  if(localStorage.plant3Height === "1-2 feet") {
    vegWeeks = "4";
  }
    if(localStorage.plant3Height === "3-4 feet") {
      vegWeeks = "8";
    }
      if(localStorage.plant3Height === "5+ feet") {
        vegWeeks = "8";
      }
        
        document.getElementById("info").innerHTML = (localStorage.plant3Grow*7)+(vegWeeks*7)+18+" days";
       
        //add Inches to LightDistance column _125W _250W _400W _600W _1000W
        if (localStorage.plant3watts === '125W')  {
          $(".lightInches").text("12 Inches");
        }
        if (localStorage.plant3watts === '250W')  {
          $(".lightInches").text("16 Inches");
        }
        if (localStorage.plant3watts === '400W')  {
          $(".lightInches").text("20 Inches");
        }
        if (localStorage.plant3watts === '600W')  {
          $(".lightInches").text("30 Inches");
        }
        if (localStorage.plant3watts === '1000W')  {
        ...
        if(localStorage.plant3Height === " 5-6 feet") {
          $(".sixteenWeeks").remove();
        }
        // filter flowering days by class in weeks
        if (localStorage.plant3Grow === '4')  {
        ...
        if (localStorage.plant3Grow === '20')  {
          $(".twentyoneFlowering").remove();
          $(".twentytwoFlowering").remove();
          $(".twentythreeFlowering").remove();
          $(".twentyfourFlowering").remove();
        }
        if (localStorage.plant3Grow === '21')  {
          $(".twentytwoFlowering").remove();
          $(".twentythreeFlowering").remove();
          $(".twentyfourFlowering").remove();
        }
        if (localStorage.plant3Grow === '22')  {
          $(".twentythreeFlowering").remove();
          $(".twentyfourFlowering").remove();
        }
        if (localStorage.plant3Grow === '23')  {
          $(".twentyfourFlowering").remove();
        }
